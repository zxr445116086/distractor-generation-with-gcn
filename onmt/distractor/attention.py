...
class HierarchicalAttention(nn.Module):
    ...
    def forward(self, source, word_bank, word_lengths,
        ...
        # attn
        align = (word_align.view(word_batch, 1, words_max_len, word_max_len) * sent_align.unsqueeze(-1)).view(word_batch, 1, words_max_len * word_max_len)
